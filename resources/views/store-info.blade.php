...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <h4 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Phone Number:{{ $storeInfo['contact_information']['0']['telephone_number'] ?? '' }}</h4>
      <h4 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">This store is currently {{ $storeInfo['status'] ?? '' }}</h4>
